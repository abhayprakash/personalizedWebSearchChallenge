...
// memory allocation
#define BUFF_SIZE_INPUT_READ 40*1024*1024ull;			// 4 GB
#define BUFF_SIZE_FEATURE_FILE 50*1024*1024ull;			// 5 GB - objects (1 in processTrain)
#define BUFF_SIZE_FEATURE_TEST_FILE 10*1024*1024ull;	// 1 GB - objects (4 in processTest)
#define BUFF_SIZE_DU_FILE 10*1024*1024ull;				// 1 GB
#define BUFF_SIZE_SU_FILE 10*1024*1024ull;				// 1 GB
#define BUFF_SIZE_QT_FILE 50*1024*1024ull;				// 5 GB
